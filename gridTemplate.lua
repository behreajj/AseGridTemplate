...
dlg:button {
    ...
    onclick = function()
        ...
        app.transaction("Set Palette", function()
            ...
            palette:setColor(2, Color { r = 128, g = 128, b = 128, a = 255 })
            palette:setColor(3, Color { r = 255, g = 255, b = 255, a = 255 })
            palette:setColor(4, Color { r = 255, g = 0, b = 0, a = 255 })
            palette:setColor(5, Color { r = 255, g = 145, b = 0, a = 255 })
            palette:setColor(6, Color { r = 255, g = 255, b = 0, a = 255 })
            palette:setColor(7, Color { r = 183, g = 255, b = 0, a = 255 })
            palette:setColor(8, Color { r = 0, g = 255, b = 0, a = 255 })
            palette:setColor(9, Color { r = 0, g = 255, b = 157, a = 255 })
            palette:setColor(10, Color { r = 0, g = 255, b = 255, a = 255 })
            palette:setColor(11, Color { r = 0, g = 169, b = 255, a = 255 })
            palette:setColor(12, Color { r = 0, g = 0, b = 255, a = 255 })
            palette:setColor(13, Color { r = 151, g = 0, b = 255, a = 255 })
            palette:setColor(14, Color { r = 255, g = 0, b = 255, a = 255 })
            palette:setColor(15, Color { r = 255, g = 0, b = 124, a = 255 })
        end)
